    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        >
          ...
          {DEALERS.map(d => (
            <option key={d.name} value={d.name}>{d.brand} · {d.name}</option>
          ))}
        </select>
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            color: 'white',
            background: selectedDealer && !loading
              ? 'var(--accent-primary)'
              : 'var(--border-medium)',
            border: 'none',
            borderRadius: 'var(--radius-md)',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: '24px', fontWeight: 800, color: getScoreColor(result.score) }}>
                {result.score}
              </span>
              <span style={{ fontSize: '10px', color: getScoreColor(result.score), fontWeight: 600 }}>
          ...
          {/* Suggestions */}
          <div>
            <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--accent-primary)', marginBottom: '8px', letterSpacing: '0.05em' }}>
              💡 改进建议
            </div>
...
function DashboardPreviewDemo() {
  ...
  useEffect(() => {
    ...
    const initCharts = () => {
      ...
      chart1.setOption({
        ...commonOption,
        title: { text: '培训完成率', left: 'center', textStyle: { fontSize: 13, color: textColor, fontWeight: 600 } },
      ...
      chart2.setOption({
        ...commonOption,
        title: { text: '学习活跃度（月活）', left: 'center', textStyle: { fontSize: 13, color: textColor, fontWeight: 600 } },
        tooltip: { trigger: 'axis' },
        xAxis: {
          type: 'category',
      ...
      chart3.setOption({
        ...commonOption,
        title: { text: '认证通过率', left: 'center', textStyle: { fontSize: 13, color: textColor, fontWeight: 600 } },
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '4px' }}>原来需要</div>
              <div style={{ fontSize: '20px', fontWeight: 700, color: '#e07070' }}>
                {SCENARIOS[selected].before}
              </div>
            </div>
            <div style={{ fontSize: '24px', color: 'var(--text-light)' }}>→</div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '4px' }}>现在只要</div>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{
            ...
            下面 3 个 demo 可以直接交互，不需要注册，不需要后端
          </p>
        </div>
